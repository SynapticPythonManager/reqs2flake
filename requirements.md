...
We have setup a reproducible workflow where the user only has to manage versioning of the packages in the style above instead of the style below with 400 lines requirements that is needed to create a lock file for the environment they are importing:
...
### current output
```bash
[owner@nixos:~]$ cd ~/sync/reqs2flake && ./reqs2flake.sh && cd ./numtest && nix develop --impure
...
++ sha256sum /home/owner/sync/reqs2flake/numtest/requirements.bak.txt
++ awk '{print $1}'
+ bakhash=f0e6d7bcaaa982cc5de74f87495d7f7421c03e864cef6eafc3b70f6cb3828568
+ bakhash=b3828568
+ echo b3828568
b3828568
+ handle_git
...
+ git commit -m 'init local flake - reqs2flake.sh preparing b3828568 for development'
[main (root-commit) 767a8a6] init local flake - reqs2flake.sh preparing b3828568 for development
...
[owner@nixos:~/sync/reqs2flake/numtest]$ cd ~/sync/reqs2flake && ./versions.sh
